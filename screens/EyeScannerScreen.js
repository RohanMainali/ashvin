...
const EyeScannerScreen = ({ navigation, addHistoryEntry, isDarkMode }) => {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text }]}>Eye Analysis</Text>
          <TouchableOpacity 
            style={styles.helpButton}
            onPress={() => Alert.alert("Help", "Take a clear, well-lit photo of your eyes. Ensure good lighting and keep your eyes open for the best results.")}
          >
      ...
      >
        ...
        >
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: colors.text }]}>Eye Health Detection</Text>
            <Text style={[styles.cardSubtitle, { color: colors.text }]}>
              AI-powered analysis for ocular conditions
            </Text>
          </View>
          ...
          <View style={styles.contextSection}>
            ...
            >
              <TextInput
                ...
                placeholder="Describe symptoms (e.g., 'redness for 2 days', 'itchy eyes', etc.)"
          ...
          <View style={styles.imageSection}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Eye Image</Text>
            <View style={styles.imageContainer}>
              {imageUri ? (
                ...
                >
                  <Ionicons name="eye-outline" size={64} color={colors.text} opacity={0.4} />
          ...
          >
            ...
            >
              ...
              <Text style={styles.analyzeButtonText}>
                {isLoading ? "Analyzing Image..." : "Analyze Eye Condition"}
              </Text>
            </LinearGradient>
          </TouchableOpacity>
        )}
        ...
        >
          ...
          <View style={styles.tipsList}>
            ...
            <View style={styles.tipItem}>
              <Ionicons name="checkmark-circle" size={16} color={Colors.accentGreen} />
              <Text style={[styles.tipText, { color: colors.text }]}>Keep your eyes open and steady</Text>
            </View>
            <View style={styles.tipItem}>
              <Ionicons name="checkmark-circle" size={16} color={Colors.accentGreen} />
              <Text style={[styles.tipText, { color: colors.text }]}>Look directly at the camera lens</Text>
            </View>
          </View>
        </LinearGradient>
      </ScrollView>
